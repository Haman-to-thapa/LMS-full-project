...
const HeroSection = () => {
  return (
    <div className='relative bg-gradient-to-r from-blue-500 to bg-indigo-600
    ...
    '>
      <div className="max-w-3xl mx-auto">
        ...
        <Button className="mt-10 bg-white text-blue-600 hover:bg-indigo-400 hover:scale-105 dark:bg-gray-800 rounded-full">Explore Courses</Button>
      </div>
